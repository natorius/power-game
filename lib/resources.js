...
exports.init  = function(numPlayers) {
  gameState.resources.setCoal(   24);
  gameState.resources.setOil(    18);
  gameState.resources.setTrash(   6);
  gameState.resources.setUranium( 2);
}

exports.count = function(type) {
  return gameState.resources[type];
}
...
var cost = function(count, type) {
  ...
  var totalCost = 0;
  var resourceRemaining = gameState.resources[type];
...
exports.buy = function(count, type) {
  ...
  gameState.resources[type] -= count;
  return resourceCost;
}
...
exports.replenish = function() {
  ...
  _.each(counts, function(replenishAmount, type) {
    gameState.resources["increment" + util.ucFirst(type)](replenishAmount);
  });
}
