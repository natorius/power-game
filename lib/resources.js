...
var resources = { coal: 0, oil: 0, trash: 0, uranium: 0 };
...
var cost = function(count, type) {
  ...
  var totalCost = 0;
  var resourceRemaining = resources[type];
...
exports.replenish = function(gameState) {
  var counts = replenishCount[gameState.players][gameState.stage];
  _.each(counts, function(replenishAmount, type) {
    resources[type] += replenishAmount;
  });
}
